...
import { innerForm, mainContainer, subtitle, title, titleContainer } from "../stylesCommon";
                    ...
                    {addOns.map((addOn, i) => (
                        <label className={cn("w-full flex py-2 md:py-4 px-2 md:px-5 border-[1px] border-light-gray rounded-lg items-center justify-between",
                            ...
                            <div className="flex gap-3 md:gap-5 items-center justify-start">
                                ...
                                <div>
                                    <h4 className={cn("font-bold text-marine-blue text-base md:text-lg")}>{addOn.name}</h4>
                                    <p className={cn("text-sm md:text-base text-cool-gray")}>{addOn.description}</p>
                                </div>
                            </div>
